...
/**
 * @file
 * Contains \Drupal\video_filter\Plugin\VideoFilter\Facebook.
 */
 ...
 *   example_url = "https://www.facebook.com/video.php?v=10152795258318553",
 *   regexp = {
...
class Facebook extends VideoFilterBase {
  ...
  public function iframe($video) {
    return [
      'src' => 'https://www.facebook.com/video/embed?video_id=' . $video['codec']['matches'][1],
      'properties' => [
